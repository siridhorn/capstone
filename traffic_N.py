...
# N
ZONE_OUT_POLYGONS = [
    np.array([[255, 292], [657, 292], [1220, 467], [218, 512]]),
    np.array([[1220, 467], [1694, 444], [1892, 489], [1700, 615]]),
]

ZONE_IN_POLYGONS = [
    np.array([[657, 292], [1048, 289], [1694, 444], [1220, 467]]),
    np.array([[218, 512], [1220, 467], [1700, 615], [167, 748]]),
]

# class_ids of interest - car, bus and truck
CLASS_ID = [2, 5, 7]

SOURCE_VIDEO_PATH = "2024-03-01 08-00-00 192.168.1.143-N#5.avi"
TARGET_VIDEO_PATH = f"C:/sasa/capstone/traffic_{today}_N.avi"
